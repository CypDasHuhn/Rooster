package dev.cypdashuhn.rooster_worldedit.commands
...
import dev.cypdashuhn.rooster_worldedit.adapter.toRegion
import dev.cypdashuhn.rooster_worldedit.adapter.worldEditSelection
...
object WESelectionArgument {
    fun cornerSelection(
        ...
        val arg = dev.cypdashuhn.rooster.commands.Arguments.literal.single(
            name = name,
            key = key,
