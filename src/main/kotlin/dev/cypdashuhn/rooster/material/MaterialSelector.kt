package dev.cypdashuhn.rooster.material

import dev.cypdashuhn.rooster.util.PredicateCombinator
import dev.cypdashuhn.rooster.util.and
import dev.cypdashuhn.rooster.util.andNot
import dev.cypdashuhn.rooster.util.or
...
class MaterialSelector {
    ...
    fun get(vararg filter: Pair<SelectorType, MaterialGroup>): List<Material> {
        ...
        if (excludeLegacy) {
            condition = SelectorType.EXCLUdev.combinator(condition!!, MaterialGroup.LEGACY.materialSelector)
        }
