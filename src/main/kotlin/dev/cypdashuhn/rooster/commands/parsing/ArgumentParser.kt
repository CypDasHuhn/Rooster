package dev.cypdashuhn.rooster.commands.parsing

import dev.cypdashuhn.rooster.commands.ArgumentInfo
import dev.cypdashuhn.rooster.commands.BaseArgument
import dev.cypdashuhn.rooster.commands.CommandContext
...
object ArgumentParser {
    ...
    fun parse(
        ...
        val topArgument = requireNotNull(
            Rooster.registered.commands.firstOrNull { arg -> arg.labels.any { it.lowercase() == label.lowercase() } }
